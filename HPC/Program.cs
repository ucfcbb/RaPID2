using RaPIDv2_HPC_1._0;
using static RaPIDv2_HPC_1._0.Utl;
...
internal class Program
{
    ...
    public static int nInstanceHP_PBWT = 10;
    public static int nInstanceLM = 10;
    ...
    {
        Console.WriteLine("RaPID v2 HPC-1.0");
        #region user inputs
        ...
        nThread_MAF = nCore / 6;
        nThread_BitConv = nCore - 2 - nThread_MAF - 2;
        nThread_PD = nCore / nInstanceHP_PBWT;
        nThread_LM = nCore / nInstanceLM;
        nThread_VO = nCore - nWriter - 2;
        ...
        Console.WriteLine("nInstanceLM: " + nInstanceLM);
        ...
        Task t5 = Task.Run(() => pal.Run_PD());
        t5.Wait();

        HPPBWT.LM_VO_v3 lm = new HPPBWT.LM_VO_v3();
        Task t6 = Task.Run(() => lm.Run());
        ...
        Task t7 = Task.Run(() => Program.BW.Run(false));
